...
def place_your_one_ship(board, ship):
    ...
    # if ship <= 2:
    #     set_ship_again = input(
    #         "\nIf you want to place your ships from the beginning, please insert \"reset\"\n").lower()
    #
    #     if set_ship_again == "reset":
    #         yours_ship()
    #         flag = False
    #         return
    #     else:
...
def game():
    ...
    player_two = input("\nWhat is the second player name? ")

    print(f"\n {player_one} please set your ships on the board.\n")
    print("Remember ships can touch their corners but they can't be side by side!\n")
    ...
    while not winner:
        ...
        print(f"{player_one} shooting board")
        ...
        print(f"{player_two} shooting board")
